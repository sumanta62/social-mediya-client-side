                ...
                <div className='max-w-lg m-auto'>
                    <div className="flex flex-col  p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
                        <div className="flex space-x-4">
                            <img alt="" src={mediaDetails.profileImg ? mediaDetails.profileImg : "https://source.unsplash.com/100x100/?portrait"} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
                            <div className="flex flex-col space-y-1">
                                <Link rel="noopener noreferrer" href="#" className="text-sm font-semibold">{mediaDetails.name ? mediaDetails.name : 'Leroy Jenkins'}</Link>
                                <span className="text-xs dark:text-gray-400">{mediaDetails.job ? mediaDetails.job : 'Android | Flutter | Sr. Software Engineer '} </span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className='flex justify-between'>
                                <div className='flex cursor-pointer items-center'>
                                    ...
                                    <p className="text-sm mx-2">Md.Nayon and {mediaDetails.like ? mediaDetails.like : ''} others</p>
                                </div>
                                <div>
