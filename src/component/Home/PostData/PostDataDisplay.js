                ...
                medias.map((media, i) =>
                    <div className='max-w-lg m-auto'>
                        <div className="flex flex-col  p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
                            ...
                            <div>
                                <p className='text-sm mb-2'>{media?.description ? media?.description : "No message"}</p>
                                <img src={media?.images ? media?.images : ''} alt="" className="object-cover w-full mb-4 dark:bg-gray-500" />
                                <div className='flex justify-between'>
                                    <div className='flex cursor-pointer items-center'>
                                        ...
                                        <p className="text-sm mx-2">Md.Nayon and {media?.like ? media?.like + count : count } others</p>
                                    </div>
                                    <div>
